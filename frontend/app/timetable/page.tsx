  ...
  return (
    <AppShell>
      <>
        ...
        <div id="web-workspace-container" className="space-y-6 max-w-7xl mx-auto tt-animate-fade pb-12 print:hidden">
          <PageHeader
                        ...
                        return (
                          ...
                          >
                            {cellEntries.length === 0 ? (
                              <div
                                onClick={() => slot && handleOpenAssignModal(day, period, slot)}
